...
int wmain( int argc, wchar_t *argv[] )
{
	...
	while( ( c = getopt( argc, argv, L"n:a:h" ) ) >= 0 ) {
		if( c == 'n' ) n = _wtoi( optarg );
		else if( c == 'a' ) algo = _wtoi( optarg );
		else if( c == 'h' ) {
	...
	printResult( algo, n, (double)( clock() - t ) / CLOCKS_PER_SEC, m[ n / 2 ][ n / 2 ] );
